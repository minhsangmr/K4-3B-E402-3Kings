...
| ③ Cài đặt LLM | OpenAI · Anthropic · Gemini · OpenRouter · Custom (OpenAI-compatible, vd Ollama), mỗi provider có base URL + model mặc định, nút kiểm tra kết nối, xem system prompt. | Có key → **Working**: mỗi lượt là 1 lời gọi LLM thật, guard-rail vẫn chạy trong code. |
